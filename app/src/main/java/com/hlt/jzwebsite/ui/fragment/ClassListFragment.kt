...
import com.hlt.jzwebsite.adapter.ClassListAdapter
...
import com.hlt.jzwebsite.viewmodel.ClassListViewModel
...
class ClassListFragment : BaseFragment() {
    ...
    private val viewModel by lazy {
        ViewModelProviders.of(this, object : ViewModelProvider.Factory {
            ...
            override fun <T : ViewModel?> create(modelClass: Class<T>): T {
                val repository = ClassListRepository(HttpManager.getInstance(), uid)
    ...
    private val adapter by lazy {
        ClassListAdapter { viewModel.retry() }
    }
